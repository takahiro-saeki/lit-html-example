...
var v1 = __webpack_require__(95);
var v4 = __webpack_require__(96);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(45), __webpack_require__(98)(module)))
...
customElements.define('custom-todo', _Todo2.default);
...
var _litExtended = __webpack_require__(97);
...
var _mock = __webpack_require__(110);

var _mock2 = _interopRequireDefault(_mock);

var _defaultFilter = __webpack_require__(111);
...
var Todo = function (_CustomElement2) {
  (0, _inherits3.default)(Todo, _CustomElement2);

  Todo.prototype.attributeChangedCallback = function attributeChangedCallback(name, oldValue, newValue) {
    switch (name) {
      case 'change':
  ...
  (0, _createClass3.default)(Todo, null, [{
  ...
  function Todo() {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, _CustomElement2.call(this));

    _this.state = {
      data: _mock2.default,
      filter: _defaultFilter2.default,
      currentFilter: 'All'
    };
    return _this;
  }

  Todo.prototype.change = function change(newValue) {
    var _state = this.state,
        data = _state.data,
        currentFilter = _state.currentFilter,
        filter = _state.filter;

    var newState = data.map(function (item) {
      if (item.id === newValue) {
        var merge = Object.assign({}, item, {
    ...
    var filterData = this.filter(currentFilter);
  ...
  Todo.prototype.update = function update() {
    var _state2 = this.state,
        currentFilter = _state2.currentFilter,
  ...
  Todo.prototype.delete = function _delete(newValue) {
    var _state3 = this.state,
        data = _state3.data,
        currentFilter = _state3.currentFilter,
        filter = _state3.filter;

    var newState = data.filter(function (item) {
  ...
  Todo.prototype.filterState = function filterState(newValue) {
    var _state4 = this.state,
        currentFilter = _state4.currentFilter,
        filter = _state4.filter;

    var optimize = filter.map(function (item) {
      var param = {
        type: item.type,
  ...
  Todo.prototype.allCheckState = function allCheckState() {
    var _state5 = this.state,
        data = _state5.data,
        currentFilter = _state5.currentFilter,
        filter = _state5.filter;

    var optimize = data.map(function (item) {
      var merge = Object.assign({}, item, { isChecked: true });
      return merge;
    });
  ...
  Todo.prototype.init = function init(newValue) {
    var _state6 = this.state,
        data = _state6.data,
        currentFilter = _state6.currentFilter,
        filter = _state6.filter;

    if (!this.read()) {
      var _optimize = filter.map(function (item) {
        var param = {
          type: item.type,
          isSelected: item.type === newValue ? true : false
        };
      ...
      var _filterData = this.filter(currentFilter);
      this.generate(_filterData, filter);
      return;
    }
  ...
  Todo.prototype.setState = function setState() {
    var option = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    this.state = Object.assign({}, this.state, option);
  };

  Todo.prototype.generate = function generate(data, filter) {
    var el = document.querySelector('custom-todo');
    (0, _litExtended.render)((0, _App2.default)(data, filter), el);
  };

  Todo.prototype.filter = function filter(flag) {
    switch (flag) {
      case 'All':
        return this.state.data;
      case 'Active':
        {
          var param = this.state.data.filter(function (item) {
      ...
      case 'Completed':
        {
          var _param = this.state.data.filter(function (item) {
  ...
  Todo.prototype.createTodo = function createTodo(data) {
    var param = {
  ...
  Todo.prototype.store = function store() {
  ...
  Todo.prototype.connectedCallback = function connectedCallback() {
    var _this2 = this;

    var filterFlag = (0, _lodash.upperFirst)(location.hash.split('/')[1]);
    this.setAttribute('init', filterFlag);
    var input = document.querySelector('[inputField]');
    input.addEventListener('keypress', function (e) {
      if (e.keyCode === 13) {
        _this2.createTodo(e.target.value);
        e.target.value = '';
      }
    });
  };
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(32)(Function.call, __webpack_require__(40).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "html", function() { return __WEBPACK_IMPORTED_MODULE_0__lit_html_js__["html"]; });
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
class PropertyPart extends __WEBPACK_IMPORTED_MODULE_0__lit_html_js__["AttributePart"] {
    setValue(values, startIndex) {
        ...
        if (s.length === 2 && s[0] === '' && s[s.length - 1] === '') {
            ...
            value = Object(__WEBPACK_IMPORTED_MODULE_0__lit_html_js__["getValue"])(this, values[startIndex]);
        }
        else {
            ...
            for (let i = 0; i < s.length; i++) {
                value += s[i];
                if (i < s.length - 1) {
                    value += Object(__WEBPACK_IMPORTED_MODULE_0__lit_html_js__["getValue"])(this, values[startIndex + i]);
                }
            }
        }
...
var _taggedTemplateLiteralLoose2 = __webpack_require__(9);
...
var _MainField = __webpack_require__(101);

var _MainField2 = _interopRequireDefault(_MainField);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var App = function App(data, filter) {
  return (0, _litHtml.html)(_templateObject, (0, _Header2.default)('lit-html/ example', 'placeholder'), (0, _MainField2.default)(data, filter));
};
...
var _templateObject = (0, _taggedTemplateLiteralLoose3.default)(['\n  <header class="header">\n    <h1>', '</h1>\n    <input class="new-todo" placeholder="', '" autofocus="" inputField>\n  </header>\n'], ['\n  <header class="header">\n    <h1>', '</h1>\n    <input class="new-todo" placeholder="', '" autofocus="" inputField>\n  </header>\n']);

var _litHtml = __webpack_require__(1);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Header = function Header(title, placeholder) {
  return (0, _litHtml.html)(_templateObject, title, placeholder);
};
...
var _templateObject = (0, _taggedTemplateLiteralLoose3.default)(['\n  <section style="display: block;" class="main">\n    <input class="toggle-all" type="checkbox">\n    <label for="toggle-all" on-click="', '">Mark all as complete</label>\n    <ul class="todo-list">\n      ', '\n    </ul>\n    ', '\n  </section>\n'], ['\n  <section style="display: block;" class="main">\n    <input class="toggle-all" type="checkbox">\n    <label for="toggle-all" on-click="', '">Mark all as complete</label>\n    <ul class="todo-list">\n      ', '\n    </ul>\n    ', '\n  </section>\n']);
...
var _allCheck = __webpack_require__(109);

var _allCheck2 = _interopRequireDefault(_allCheck);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var MainField = function MainField(items, filter) {
  return (0, _litHtml.html)(_templateObject, function () {
    return (0, _allCheck2.default)();
  }, items.map(function (item) {
    return (0, _TodoItem2.default)(item);
  }), (0, _Footer2.default)(items, filter));
};

exports.default = MainField;
...
var _count = __webpack_require__(103);

var _count2 = _interopRequireDefault(_count);

var _FooterItem = __webpack_require__(104);
...
var Footer = function Footer(item) {
  var filter = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
  return (0, _litHtml.html)(_templateObject, (0, _count2.default)(item), filter.map(function (item) {
    return (0, _FooterItem2.default)(item);
  }));
};
...
var _filterChange = __webpack_require__(105);

var _filterChange2 = _interopRequireDefault(_filterChange);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var FooterItem = function FooterItem(filter) {
  return (0, _litHtml.html)(_templateObject, filter.type === 'All' ? '' : filter.type.toLowerCase(), (0, _litHtml.directive)(function () {
    return filter.isSelected ? 'selected' : '';
  }), function (e) {
    return (0, _filterChange2.default)(e);
  }, filter.type);
};
...
var filterChange = function filterChange(event) {
  var parent = document.querySelector('custom-todo');
  var flag = (0, _lodash.trim)(event.target.textContent);
...
var _templateObject = (0, _taggedTemplateLiteralLoose3.default)(['\n  <li id="', '" className="', '">\n    <input class="toggle" type="checkbox" on-click="', '" checked="', '">\n    <label>', '</label>\n    <button class="destroy" on-click="', '"></button>\n  </li>\n'], ['\n  <li id="', '" className="', '">\n    <input class="toggle" type="checkbox" on-click="', '" checked="', '">\n    <label>', '</label>\n    <button class="destroy" on-click="', '"></button>\n  </li>\n']);

var _litHtml = __webpack_require__(1);

var _deleteChild = __webpack_require__(107);

var _deleteChild2 = _interopRequireDefault(_deleteChild);

var _check = __webpack_require__(108);
...
var TodoItem = function TodoItem(item) {
  return (0, _litHtml.html)(_templateObject, item.id, (0, _litHtml.directive)(function () {
    return item.isChecked ? 'completed' : '';
  }), function (e) {
    return (0, _check2.default)(e);
  }, item.isChecked, item.title, function (e) {
    return (0, _deleteChild2.default)(e);
  });
};
